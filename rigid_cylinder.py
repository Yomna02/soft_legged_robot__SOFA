...
def createScene(rootNode):
    ...
    sphere.addObject('MechanicalObject', name="mstate", template="Rigid3", translation2=[0., 0., 0.], rotation2=[0., 0., 0.], showObjectScale=1)
    ...
    collision.addObject('MeshOBJLoader', name="loader", filename="mesh/leg.obj", triangulate="true", scale=1.0)
    ...
    sphereVisu.loader = sphereVisu.addObject('MeshOBJLoader', name="loader", filename="mesh/leg.obj")
    sphereVisu.addObject('OglModel', name="model", src="@loader", scale3d=1, color=[0., 1., 0.], updateNormals=False)
